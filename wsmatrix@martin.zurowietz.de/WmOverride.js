...
var WmOverride = class {
   ...
   _showWorkspaceSwitcher(display, window, binding) {
      ...
      if (this.cacheSwitcher && this.rerender && this.wm._workspaceSwitcherPopup instanceof BaseWorkspaceSwitcherPopup) {
         log("rerenderign switcher ...");
         this.rerender = false;
