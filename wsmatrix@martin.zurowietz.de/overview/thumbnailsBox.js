...
var ThumbnailsBox = class {
    ...
    _overrideOriginalProperties() {
        this._thumbnailsBox._overrideProperties = {};
        this.overrideProperties.forEach(function (prop) {
            this._thumbnailsBox._overrideProperties[prop] = this._thumbnailsBox[prop].bind(this._thumbnailsBox);
            this._thumbnailsBox[prop] = this[prop].bind(this._thumbnailsBox);
        }, this);
    }

    _restoreOriginalProperties() {
        this.overrideProperties.forEach(function (prop) {
            this._thumbnailsBox[prop] = this._thumbnailsBox._overrideProperties[prop];
        }, this);
    }

    get _thumbnailsBox() {
        return Main.overview._overview._controls._thumbnailsBox
    }
    ...
    allocate(box) {
        ...
        for (let i = 0; i < this._thumbnails.length; i++) {
            ...
            print(childBox.x1 + ", " + childBox.x2 + ", " + childBox.y1 + ", " + childBox.y2 + ", " + childBox.get_width() + ", " + childBox.get_height())
